// -----
// OneButton2.h - Library for detecting button clicks, doubleclicks and long press pattern on a single button.
...
public:
  ...
  // attach parameterd functions that will be called when button was pressed in the specified way.
  void attachClick(callbackFunctionInt newFunction);
  void attachDoubleClick(callbackFunctionInt newFunction);
  void attachPress(callbackFunctionInt newFunction); // DEPRECATED, replaced by longPressStart, longPressStop and duringLongPress
  void attachLongPressStart(callbackFunctionInt newFunction);
  void attachLongPressStop(callbackFunctionInt newFunction);
  void attachDuringLongPress(callbackFunctionInt newFunction);
...
private:
  ...
  // These variables will hold parameterd functions acting as event source.
  callbackFunctionInt _clickFuncInt;
  callbackFunctionInt _doubleClickFuncInt;
  callbackFunctionInt _pressFuncInt;
  callbackFunctionInt _longPressStartFuncInt;
  callbackFunctionInt _longPressStopFuncInt;
  callbackFunctionInt _duringLongPressFuncInt;
